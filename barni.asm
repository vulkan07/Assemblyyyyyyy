...
KEZD01	CLR BIP		;start turn off LED
CIM1 	SETB EROH 	;1-re allitja a kapcsolo vonalat
	JB EROH,CIM2	;elugrik cim2-re
	SETB BIP	;turn on LED
	JMP CIM1	
CIM2 	CLR BIP		;turn off LED
	JMP CIM1	
